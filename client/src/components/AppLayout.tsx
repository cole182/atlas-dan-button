          ...
          {!collapsed && (
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 10, color: "oklch(0.45 0.02 40)", letterSpacing: "0.06em", fontFamily: "'JetBrains Mono', monospace" }}>DAN BUTTON PROPERTIES</div>
              </div>
            </div>
          )}
          {collapsed && (
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 8px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 12, fontWeight: 700, color: "oklch(0.72 0.18 65)",
                }}>C</div>
                <div>
                  <div style={{ fontSize: 12, fontWeight: 600, color: "oklch(0.85 0.01 60)" }}>Dan</div>
