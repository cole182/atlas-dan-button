...
const SEVERITY_STYLE: Record<string, { color: string; bg: string }> = {
  ...
  "Major": { color: "oklch(0.72 0.18 65)", bg: "oklch(0.60 0.20 28 / 0.1)" },
    ...
    <div style={{ maxWidth: 1100 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 12, marginBottom: 24 }}>
        {[
          ...
          { label: "Major Fires", value: "4", color: "oklch(0.72 0.18 65)" },
      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 16 }}>
        {severities.map(s => (
          <button key={s} onClick={() => setFilter(s)} style={{
            ...
            background: filter === s ? "oklch(0.72 0.18 65)" : "transparent",
            borderColor: filter === s ? "oklch(0.72 0.18 65)" : "oklch(0.22 0.015 30)",
