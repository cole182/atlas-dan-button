...
// NOTE: scrapeAll above is replaced by the extended version below that includes all 11 lead types.
// The above scrapeAll is kept for reference but the index.ts calls the exported functions directly.
